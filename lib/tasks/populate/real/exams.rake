...
namespace :db do
  namespace :populate do
    namespace :real do
        task add_exams_22FEB_bolsao: :environment do
          p 'Adding exams'
          datetime = 'Mon, 22 Feb 2014 14:00:00 BRT -03:00'
        ...
        task add_exams_20FEB: :environment do
          p 'Adding exams'
          datetime = 'Mon, 20 Feb 2014 14:00:00 BRT -03:00'
          cycle_name = 'Ciclo 0 - '
          exam_name = '1º Simulado'
          array = [
            'C - 1ª Série Militar - Bangu, Nova Iguaçu - POR(15) + MAT(15): ACBECDAEBADCEDC BACEEDEBDCCBBBD',
            'C - 2ª Série Militar - Bangu, Nova Iguaçu, São Gonçalo II - POR(15) + MAT(15): ACBECDAEBADCEDC BACEEDEBDCCBBBD',
            'C - 9º Ano Militar - Bangu, Nova Iguaçu - POR(15) + MAT(15): ACBECDAEBADCEDC BACEEDEBDCCBBBD',
            'C - AFA/EN/EFOMM - Bangu, Nova Iguaçu - POR(15) + MAT(15): CADDDADDBDBDBDA DCECDDEADDECDCE',
            'C - ESPCEX - Bangu, Nova Iguaçu - POR(15) + MAT(15): CADDDADDBDBDBDA DCECDDEADDECDCE',
            'C - IME-ITA - Bangu, Nova Iguaçu - POR(15) + MAT(15): CADDDADDBDBDBDA DCECDDEADDECDCE']
        ...
        task add_exams_11JAN: :environment do
          ...
          exam_name = 'Prova'
          array = [
            'C - 1ª Série ENEM, 1ª Série Militar, 2ª Série ENEM, 2ª Série Militar - All - POR(15) + MAT(15): AAAAAAAAAAAAAAA AAAAAAAAAAAAAAA - Manhã',
            'C - 1ª Série ENEM, 1ª Série Militar, 2ª Série ENEM, 2ª Série Militar - All - POR(15) + MAT(15): AAAAAAAAAAAAAAA AAAAAAAAAAAAAAA - Tarde',
            'C - 6º Ano - All - POR(15) + MAT(15): AAAAAAAAAAAAAAA AAAAAAAAAAAAAAA - Manhã',
            'C - 6º Ano - All - POR(15) + MAT(15): AAAAAAAAAAAAAAA AAAAAAAAAAAAAAA - Tarde',
            'C - 7º Ano, 8º Ano - All - POR(15) + MAT(15): AAAAAAAAAAAAAAA AAAAAAAAAAAAAAA - Manhã',
            ...
            'C - Pré-Vestibular Biomédicas, Pré-Vestibular Manhã, Pré-Vestibular Noite - All - POR(15) + MAT(15): AAAAAAAAAAAAAAA AAAAAAAAAAAAAAA - Tarde'
          ]
          create_exams_bolsao(array, datetime, cycle_name, exam_name)
        end
        task add_exams_18DEC: :environment do
          p 'Adding exams'
          datetime = 'Mon, 18 Dec 2013 14:00:00 BRT -03:00'
          cycle_name = 'Recuperação - Final - '
          exam_name = 'Prova'
          array = [
            'C - 1ª Série ENEM - All - GEO(10): ADEBBDEDAB',
            'C - 1ª Série ENEM - All - POR(10): ABCEBCDCAB',
            'C - 2ª Série ENEM - All - GEO(10): EEEDACBCBB',
            'C - 2ª Série ENEM - All - POR(10): BAECBCADED'
          ]
        ...
        task add_exams_17DEC: :environment do
          ...
          exam_name = 'Prova'
          array = [
            'C - 9º Ano Forte - All - EDF(10): CABCDCDACE',
            'C - 9º Ano Forte - All - GEO(10): DCDAADADBC',
            'C - 9º Ano Forte - All - QUI(10): BCDCECDAAD'
          ]
          create_exams_school(array, datetime, cycle_name, exam_name)
        end  
        ...
        task add_exams_13DEC: :environment do
          ...
          exam_name = 'Prova'
          array = [
            'C - 9º Ano Forte - All - FIS(10):  CBDDBADABE',
            'C - 9º Ano Forte - All - HIS(10):  ABECDBDDEE'
          ]
          create_exams_school(array, datetime, cycle_name, exam_name)
        end
        task add_exams_12DEC_2: :environment do
          p 'Adding exams'
          datetime = 'Mon, 12 Dec 2013 14:00:00 BRT -03:00'
          cycle_name = 'Recuperação - Final - '
          exam_name = 'Prova'
          array = [
            'C - 9º Ano Forte - All - BIO(10):  ACDADCCCCB',
            'C - 9º Ano Forte - All - ING(10):  CCBADCDDBE',
            'C - 9º Ano Forte - All - POR(10):  EDCDDCEAAE'
          ]
          create_exams_school(array, datetime, cycle_name, exam_name)
        end
        ...
        task add_exams_06DEC_1: :environment do
          ...
          exam_name = 'Prova'
          array = [
            'C - 1ª Série Militar - All - BIO(10) + QUI(10): DBEBCEECDD ABDAEDCCBE',
            'C - 2ª Série Militar - All - BIO(10) + QUI(10): BCBCCDDCBA BCBCBBBDCC',
        ...
        task add_exams_04DEC: :environment do
          p 'Adding exams'
          datetime = 'Mon, 04 Dec 2013 14:00:00 BRT -03:00'
          cycle_name = 'Recuperação - 4º Bimestre - '
          exam_name = 'Prova'
          array = [
            'C - 1ª Série Militar, 9º Ano Militar - All - HIS(10) + GEO(10): EECCCCABAC CECDBEDDBC',
            'C - 2ª Série Militar - All - HIS(10) + GEO(10): ECDBCDAEAC BDBECCBDDB'
          ]
          create_exams_school(array, datetime, cycle_name, exam_name)
        end
