    ...
    namespace :real do
      task add_exams_08JUN: :environment do
        ...
        array = [
          ...
          'C - 1ª Série Militar - All - POR(20) + GEO(5) + HIS(6) + FIS(6) + QUI(6) + BIO(6): EAEBDEBDEADACBCACDED DCAEAB DBCDDA DAADAD AECDCB CADDDC',
          'C - CN/EPCAR, 9º Ano Militar - All - POR(20) + GEO(5) + HIS(6) + FIS(6) + QUI(6) + BIO(6): EAEBDEBDEADACBCACDED DCAEAB DBCDDA DAADAD ECAEDB CADDDC',
          'C - 2ª Série Militar - All - MAT(10) + FIS(10) + POR(6) + ING(10): CCCBADACDE ACDCDCDCAD CEDCBADCEA DCBEBAECBE',
